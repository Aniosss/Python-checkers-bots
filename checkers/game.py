...
class Game:
    ...
    def __predict_optimal_moves(self, side):
    ...
    def __get_predicted_moves_list(self, side, current_prediction_depth: int = 0,
    ...
    def __get_moves_list(self, side):
    ...
    def __get_required_moves_list(self, side):
    ...
    def __get_optional_moves_list(self, side):
